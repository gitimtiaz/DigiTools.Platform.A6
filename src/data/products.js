const products = [
  ...
  },
  {
    ...
    description:
      "Boost your website's search rankings with AI-powered SEO analysis and recommendations.",
    price: 49,
    period: "monthly",
    tag: "Popular",
    tagType: "popular",
    features: ["Keyword research", "Competitor analysis", "Monthly reports"],
    icon: "🔍",
  },
  {
    id: 8,
    ...
    description:
      "Professional video editing tools with AI-powered effects and auto-subtitles.",
    price: 59,
    period: "yearly",
    tag: "New",
    tagType: "new",
    features: ["4K export", "AI subtitles", "500+ transitions"],
    icon: "🎬",
  },
];
