            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-11 h-11 bg-white hover:bg-violet-600 rounded-full flex items-center justify-center text-gray-900 hover:text-white transition-all duration-300"
                >
                  {social.svg}
                </a>
              ))}
