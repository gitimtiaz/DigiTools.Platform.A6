...
function ProjectCard({ project }: { project: Project }) {
  if (project.featured) {
    return (
      <div className="glass-card rounded-3xl overflow-hidden group hover:-translate-y-2 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(192,193,255,0.1)] lg:col-span-2">
  ...
  return (
    <div className="glass-card rounded-3xl overflow-hidden group hover:-translate-y-2 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(192,193,255,0.1)]">
