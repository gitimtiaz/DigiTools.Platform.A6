  ...
  return (
    ...
    >
      ...
      <div className="relative mb-6 group">
        <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-primary to-secondary blur opacity-30 group-hover:opacity-50 transition duration-1000" />
        <Image
      ...
      {/* Name */}
      <h1 className="font-h1 text-h1 text-on-background mb-4 max-w-4xl">
        Imtiaz Ahamed
      </h1>

      {/* Tagline */}
      <p className="text-gradient font-h3 text-h3 mb-6 max-w-2xl">
        👉 Frontend-Focused Web Developer | Next.js &amp; React Enthusiast
      </p>

      {/* Description */}
      <p className="font-body-lg text-body-lg text-on-surface-variant max-w-3xl mx-auto mb-12 leading-relaxed">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        <Link
          href="#projects"
          className="px-8 py-4 rounded-xl bg-primary text-on-primary font-semibold hover:shadow-[0_0_25px_rgba(192,193,255,0.3)] transition-all active:scale-95"
        >
          View Projects
        </Link>
        <Link
          href="#contact"
          className="px-8 py-4 rounded-xl border border-outline-variant hover:border-primary/50 hover:bg-white/5 transition-all active:scale-95"
        >
          Let&apos;s Talk
        </Link>
      </div>
